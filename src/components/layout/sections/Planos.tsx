...
const Planos = ({ id }: PlanosProps) => {
    return (
        <section id={id} className="w-full min-h-screen">
            <article className=" bg-[#0E0016]  px-[100px] flex flex-col items-center justify-start pt-[100px] pb-[100px] max-md:px-4 gap-4">
            ...
            <article className=" w-full bg-[#F1F5FF] py-[100px] gap-4 px-20 flex flex-col items-center justify-center">
                ...
                <h2 className="text-[#6326B9] text-[40px] max-md:text-[30px]">Satisfação garantia e risco zero!</h2>
